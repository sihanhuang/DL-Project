...
class pascal_voc(object):
    ...
    def get(self):
        ...
        labels = np.zeros(
                          (self.batch_size, self.cell_size, self.cell_size, 5+len(self.classes)))   ### Change
        count = 0
    ...
    def load_labels(self):
        ...
        if self.phase == 'train':
            txtname = os.path.join(
                                   self.data_path, 'ImageSets', 'Main', 'my_trainval.txt')   ### 'trainval.txt'
        else:
            txtname = os.path.join(
                                   self.data_path, 'ImageSets', 'Main', 'test.txt')    ### Change!!!
